...
use oauth2::{
    basic::BasicErrorResponse, DeviceCodeErrorResponse, HttpClientError, RequestTokenError,
};
...
pub enum Error {
    ...
    OAuthExecutionError(
        #[from] RequestTokenError<HttpClientError<reqwest::Error>, BasicErrorResponse>,
    ),
