...
Minecraft recorded Game Runtime not observed, online-service not observed, known anti-cheat not observed, and a PE delay-import directory observed. Forza recorded an online-service import observed, Game Runtime not observed, known anti-cheat not observed, and a PE delay-import directory observed. Delay-directory metadata does not prove that an import is actually delay-loaded, negative observations do not exclude dynamic calls, and the Forza online-service signal does not prove runtime behavior.
...
This evidence is intentionally incomplete. Minecraft now has an isolated manifest, dependency, entrypoint, protocol, capability, protected-file inventory, current update-plan record, complete XVD-tree-verified base-transfer canary, protected-content license, memfd-only decryption evidence, and a complete PE report with Game Runtime, online-service, and known anti-cheat imports not observed plus a delay-import directory observed. Forza now has bounded current header-boundary, XVC metadata, user-directory, signal-scan, update-plan records, complete transport and XVD-tree integrity evidence, protected-content license, memfd-only decryption evidence, and a complete PE report with an online-service import observed, Game Runtime and known anti-cheat imports not observed, and a delay-import directory observed. Delay-directory metadata is not proof of delay-loaded behavior, and static absence does not rule out dynamic calls. Neither target has actual Game Runtime import or runtime evidence, complete online-service classification, anti-cheat classification beyond static signals, or a source-to-target update pair. Those remaining facts require subsequent authorized, isolated workflows. The only retained acquisition evidence is the sanitized metadata described above.
