...
SRC-024 through SRC-040 remain valid. SRC-040 typed checked payload-range arithmetic; invalid fixtures inserted no records and valid behavior remained. Phase 2 and XODUS-REQ-002 remain open; the excluded account test prevents an unfiltered-suite claim. Next harden `parse_segment_metadata`: compute each segment path's UTF-16 byte length, relative bounds, and absolute read offset with checked arithmetic; validate against declared `segment_metadata.length` before buffer allocation, seek, filename decoding, or map insertion; return typed failures. Prove invalid paths cause no path read or record insertion, and preserve one valid path, with deterministic in-memory evidence and no filesystem mutation. Leave hash-slice bounds and downstream boundaries for later. No title-package, download, stream, secret-store, package-content, or runtime work. Do not begin XODUS-REQ-003 or Phase 3 until XODUS-REQ-002 closes.
...
Plan SHA-256: 5fb19bb6af339ce0a923adb64ecf86f983aa9a55caf2a5f47b5276c28a37130b
Validated handoff plan-set SHA-256: 22589d20038fd888df55c65239b54f6a6ba0d694a520fc4d8bf555099c86fc63
...
Observed checkout commit: f372b6ea024056bc985cdfa725134a90d1d97742
...
Remote-head evidence: git ls-remote read-only query observed 2026-08-25 at 05:57:32Z, corroborated by gh repo view EnVisione/xodus defaultBranchRef main
