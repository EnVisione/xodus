...
A refreshed campaign on August 26, 2026 used the current parser sources at signed checkpoint `6505727` and an exact disposable corpus containing the same 11 tracked fixture files. It completed 10,000 executions with final coverage `1647` and feature count `4280`, added 359 non-crash units, reached a peak resident set size of 405 MiB, and reported no crash artifact or sanitizer failure. The disposable corpus and generated artifacts were removed after completion. This evidence covers parser robustness only and does not prove package installation, runtime, or title lifecycle behavior.
